...
![consensus-computer](images/consensus-computer.png)
...
- The community participates in the Game of Links
- The community verifies and proposes a Genesis block with results from the Game of Links
- cyber\~()Congress deploys contracts for cyber~Foundation and cyber\~()Auction
