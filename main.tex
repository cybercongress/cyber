...
Prior to \hyperlink{genesis}{Genesis} cyber\~{}Foundation has minted 750 000 000 000 000 THC (seven hundred fifty terathc), which will be broken down as follows:
...
Mint rights must be revoked after allocation. Burn rights must be assigned to Cyber\~{}Auction contract. All decisions by cyber\~{}Foundation will be executed based on the results of THC votes. The following parameters will be applied during deployment:
