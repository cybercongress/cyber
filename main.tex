...
Our \linkred{https://github.com/cybercongress/cyberd}{cyberd} implementation is based on \linkred{https://github.com/cosmos/cosmos-sdk}{cosmos-SDK} identities, and \linkred{https://github.com/multiformats/cid#cidv0}{CIDV1} content addresses.
...
In our relevance for a common \linkred{https://github.ccom/cybercongress/cyberd}{cyberd} implementation, the rank root hash is computed on the CUDA GPUs every round.
